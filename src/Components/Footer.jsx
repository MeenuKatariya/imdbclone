...
export const Footer=()=> {
  return (
    <div style={{backgroundColor:"#000000"}}>
        <div style={{display:"flex", margin:'auto' ,width:300,justifyContent:"space-around",fontSize:30}}>
        ...
        <div  style={{display:"flex",justifyContent:"space-between" ,width:650,margin:"auto", fontFamily:"12px Roboto,Helvetica,Arial,sans-serif",color:"#FFFFFFF"}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between" ,width:700,marginLeft:"430px" ,color:"#FFFFFFF"}} >
